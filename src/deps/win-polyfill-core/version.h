...
namespace
{
    ...
    constexpr DWORD SYSTEM_WIN10_RTM =
        MakeSystemVersionCompact(10, 0, 0, 0x0000); // NTDDI_WIN10 RTM
    constexpr DWORD SYSTEM_WIN10_1507 =
        MakeSystemVersionCompact(10, 0, 10240, 0x0000); // NTDDI_WIN10 RTM
