...
JET_ERR JET_API
JetAttachDatabase(_In_ JET_SESID sesid, _In_ JET_PCSTR szFilename, _In_ JET_GRBIT grbit);
...
JET_ERR JET_API
JetCreateInstance(_Out_ JET_INSTANCE *pinstance, _In_opt_ JET_PCSTR szInstanceName);
...
JET_ERR JET_API
JetDeleteTable(_In_ JET_SESID sesid, _In_ JET_DBID dbid, _In_ JET_PCSTR szTableName);

JET_ERR JET_API JetDetachDatabase(_In_ JET_SESID sesid, _In_opt_ JET_PCSTR szFilename);
...
JET_ERR JET_API JetRestore(_In_ JET_PCSTR szSource, _In_opt_ JET_PFNSTATUS pfn);

JET_ERR JET_API
JetRestore2(_In_ JET_PCSTR sz, _In_opt_ JET_PCSTR szDest, _In_opt_ JET_PFNSTATUS pfn);
